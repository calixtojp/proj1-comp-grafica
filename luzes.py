...
class Luz:
    ...
    def aplicar(self):
        ...
        self.lightingShader.setVec3("pointLights[0].ambient", it.toggle_ex*it.toggle_pl1*self.ambient*it.amb*1.05, it.toggle_ex*it.toggle_pl1*self.ambient*it.amb*1.05, it.toggle_ex*it.toggle_pl1*self.ambient*it.amb*1.05)
        ...
        self.lightingShader.setVec3("pointLights[1].ambient", it.toggle_in_baixo*it.toggle_pl2*self.ambient*it.amb*1.05, it.toggle_in_baixo*it.toggle_pl2*self.ambient*it.amb*1.05, it.toggle_in_baixo*it.toggle_pl2*self.ambient*it.amb*1.05)
        self.lightingShader.setVec3("pointLights[1].diffuse", it.toggle_in_baixo*it.toggle_pl2*self.diffuse*it.dif*0.8, it.toggle_in_baixo*it.toggle_pl2*self.diffuse*it.dif*0.8, it.toggle_in_baixo*it.toggle_pl2*self.diffuse*it.dif*0.8)
        self.lightingShader.setVec3("pointLights[1].specular", it.toggle_in_baixo*it.toggle_pl2*self.specular*it.spec*1.0, it.toggle_in_baixo*it.toggle_pl2*self.specular*it.spec*1.0, it.toggle_in_baixo*it.toggle_pl2*self.specular*it.spec*1.0)
        ...
        self.lightingShader.setVec3("pointLights[2].ambient", it.toggle_in_cima*it.toggle_pl3*self.ambient*it.amb*0.2, it.toggle_in_cima*it.toggle_pl3*self.ambient*it.amb*0.0, it.toggle_in_cima*it.toggle_pl3*self.ambient*it.amb*0.00)
        self.lightingShader.setVec3("pointLights[2].diffuse", it.toggle_in_cima*it.toggle_pl3*self.diffuse*it.dif*1.0, it.toggle_in_cima*it.toggle_pl3*self.diffuse*it.dif*0.2, it.toggle_in_cima*it.toggle_pl3*self.diffuse*it.dif*0.0)
        self.lightingShader.setVec3("pointLights[2].specular", it.toggle_in_cima*it.toggle_pl3*self.specular*it.spec*0.8, it.toggle_in_cima*it.toggle_pl3*self.specular*it.spec*0.4, it.toggle_in_cima*it.toggle_pl3*self.specular*it.spec*0.2)
